  ...
  return (
    <AnimatePresence>
      ...
      >
        ...
        >
          {/* Hidden button for expand action */}
          <button
            className="inner-btn absolute inset-0 z-0 w-full h-full cursor-pointer opacity-0"
          ...
          <div className="flex items-center space-x-3 overflow-hidden pointer-events-none relative z-10">
          ...
          <div className="flex items-center space-x-2 shrink-0 pr-2 pointer-events-none relative z-10">
            <button
              ...
              className={`pointer-events-auto p-2 transition-colors ${isLoadingStream ? 'text-white/50 cursor-not-allowed' : 'text-white hover:text-white/80'}`}
            >
              {isLoadingStream ? (
            ...
            <button
              ...
              className="pointer-events-auto p-2 text-white hover:text-white/80 transition-colors"
            >
