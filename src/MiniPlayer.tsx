      ...
      >
        ...
        >
          <button
            ...
            className="expand-btn absolute inset-0 z-0 opacity-0 cursor-pointer w-full h-full focus-visible:outline-none"
          ...
          <div className="flex items-center space-x-2 shrink-0 pr-2 pointer-events-none z-10">
            <button
              ...
              className={`p-2 transition-colors pointer-events-auto rounded-full focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white ${isLoadingStream ? 'text-white/50 cursor-not-allowed' : 'text-white hover:text-white/80'}`}
            >
              {isLoadingStream ? (
            ...
            <button
              ...
              title="Skip Forward"
              className="p-2 text-white hover:text-white/80 transition-colors pointer-events-auto rounded-full focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white"
            >
