      ...
      >
        ...
        >
          <button
            ...
            className="absolute z-0 inset-0 w-full h-full inner-btn opacity-0 cursor-pointer"
          />

          {/* Progress Bar Line */}
          <MiniProgressBar duration={duration} audioRef={audioRef} />

          <div className="flex items-center space-x-3 overflow-hidden pointer-events-none z-10 relative">
          ...
          <div className="flex items-center space-x-2 shrink-0 pr-2 pointer-events-none z-10 relative">
            <button
              onClick={(e) => {
                e.stopPropagation();
                if (!isLoadingStream) {
              ...
              className={`p-2 transition-colors pointer-events-auto ${isLoadingStream ? 'text-white/50 cursor-not-allowed' : 'text-white hover:text-white/80'}`}
            >
              {isLoadingStream ? (
            ...
            <button
              ...
              title="Next track"
              className="p-2 text-white hover:text-white/80 transition-colors pointer-events-auto"
            >
