    ...
    <AnimatePresence>
      ...
      >
        ...
        >
          ...
          <div className="flex items-center space-x-2 shrink-0 pr-2 relative z-10 pointer-events-auto">
            <button
              onClick={(e) => {
                e.stopPropagation();
                if (!isLoadingStream) {
              ...
              title={isLoadingStream ? "Loading audio stream" : isPlaying ? "Pause" : "Play"}
