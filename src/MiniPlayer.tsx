      ...
      >
        ...
        >
          <button
            ...
            className="absolute inset-0 z-0 opacity-0 cursor-pointer expand-btn outline-none"
          />
          ...
          <div className="flex items-center space-x-2 shrink-0 pr-2 pointer-events-auto z-20">
            <button
              onClick={(e) => {
                e.stopPropagation();
                if (!isLoadingStream) {
