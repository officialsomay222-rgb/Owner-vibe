      ...
      >
        ...
        >
          ...
          <button
            ...
            aria-label={`Expand player, currently playing ${currentSong.title}`}
            className="expand-btn absolute inset-0 w-full h-full z-0 opacity-0 cursor-pointer focus-visible:outline-none"
          />
          ...
          <div className="flex items-center space-x-2 shrink-0 pr-2 pointer-events-auto relative z-10">
            <button
              onClick={(e) => {
                e.stopPropagation();
                if (!isLoadingStream) {
              ...
              className={`p-2 transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white/50 rounded-full ${isLoadingStream ? 'text-white/50 cursor-not-allowed' : 'text-white hover:text-white/80'}`}
            >
              {isLoadingStream ? (
            ...
            <button
              ...
              title="Next Track"
              className="p-2 text-white hover:text-white/80 transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white/50 rounded-full"
            >
