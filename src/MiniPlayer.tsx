      ...
      >
        ...
        >
          <button
            ...
            className="absolute inset-0 z-0 w-full h-full opacity-0 cursor-pointer expand-btn"
          />
          ...
          <div className="relative z-10 flex items-center space-x-2 shrink-0 pr-2 pointer-events-auto">
            <button
              onClick={(e) => {
                e.stopPropagation();
                if (!isLoadingStream) {
