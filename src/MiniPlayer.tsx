      ...
      >
        ...
        >
          ...
          <button
            ...
            className="expand-btn absolute inset-0 z-0 w-full h-full cursor-pointer focus:outline-none"
            aria-label={`Expand player showing ${currentSong.title}`}
            title="Expand player"
          />
          ...
          <div className="relative z-10 flex items-center space-x-3 overflow-hidden pointer-events-none">
          ...
          <div className="relative z-10 flex items-center space-x-2 shrink-0 pr-2">
            <button
              onClick={(e) => {
                e.stopPropagation();
                if (!isLoadingStream) {
              ...
              className={`p-2 transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-white/50 rounded-full ${isLoadingStream ? 'text-white/50 cursor-not-allowed' : 'text-white hover:text-white/80'}`}
            >
              {isLoadingStream ? (
            ...
            <button
              ...
              title="Next track"
              className="p-2 text-white hover:text-white/80 transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-white/50 rounded-full"
            >
