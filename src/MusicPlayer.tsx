            ...
            >
                ...
                <div className="px-4 pb-6 flex flex-col gap-1 mt-2">
                    ...
                    <div className="flex px-4 pt-4 pb-2">
                        <button aria-label="Device information" title="Device information" className="p-2.5 rounded-full bg-white/10 hover:bg-white/20 transition-colors text-white/70">
