          ...
          <div className="relative flex-1 w-full max-w-md landscape:max-w-4xl flex flex-col landscape:flex-row landscape:items-center px-8 landscape:px-12 pb-10 landscape:pb-4 mt-6 landscape:mt-2">
            ...
            <div className="w-full landscape:w-1/2 flex flex-col justify-center">
                ...
                <div className="flex items-center justify-between mb-8 landscape:mb-4 px-2 landscape:px-0">
                  ...
                  <button
                    aria-label={repeatMode === 'none' ? 'Enable repeat' : repeatMode === 'all' ? 'Enable repeat one' : 'Disable repeat'}
                    title={repeatMode === 'none' ? 'Enable repeat' : repeatMode === 'all' ? 'Enable repeat one' : 'Disable repeat'}
                ...
                <div className="flex items-center justify-between px-6 landscape:px-2 text-white/50">
                    <button aria-label={isMuted ? 'Unmute' : 'Mute'} title={isMuted ? 'Unmute' : 'Mute'} onClick={toggleMute} className="hover:text-white transition-colors active:scale-90 p-2">
                        {isMuted ? <VolumeX className="w-5 h-5 landscape:w-4 landscape:h-4" /> : <Volume2 className="w-5 h-5 landscape:w-4 landscape:h-4" />}
                    </button>
                    <button aria-label="Share" title="Share" onClick={handleShare} className="hover:text-white transition-colors active:scale-90 p-2">
            ...
            >
                ...
                <div className="px-4 pb-6 flex flex-col gap-1 mt-2">
                    ...
                    <div className="flex px-4 pt-4 pb-2">
                        <button aria-label="Device info" title="Device info" className="p-2.5 rounded-full bg-white/10 hover:bg-white/20 transition-colors text-white/70">
